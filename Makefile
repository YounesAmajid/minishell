...
#    Updated: 2023/09/22 05:38:46 by yamajid          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/env/env.c src/env/env_utils.c src/main.c src/lexer/lexer.c \
	...
	src/built_ins/pwd.c src/built_ins/builtins.c src/built_ins/cd.c src/built_ins/export.c src/built_ins/unset.c src/built_ins/cd_utils.c
